"""
Django settings for wandering_band_45026 project.
...
ROOT_URLCONF = 'wandering_band_45026.urls'
...
WSGI_APPLICATION = 'wandering_band_45026.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wandering_band_45026 API",
    "DESCRIPTION": "API documentation for wandering_band_45026 App",
    "VERSION": "v1",
}
